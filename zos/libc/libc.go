...
func Xisatty(t *TLS, fd int32) int32 {
	// TODO (joon) - I think isatty needs to be ported 
...
func Xwctomb(t *TLS, s uintptr, wc /*wchar_t*/ int32) int32 {
	panic(todo(""))
}
...
func Xwcwidth(t *TLS, c /*wchar_t*/ int32) int32 {
	panic(todo(""))
}
...
func Xgetentropy(t *TLS, buffer uintptr, length /*size_t*/ uint64) int32 {
	const max = 256
	switch {
	case length == 0:
		return 0
...
func Xreallocarray(t *TLS, ptr uintptr, nmemb, size /*size_t*/ uint64) uintptr {
